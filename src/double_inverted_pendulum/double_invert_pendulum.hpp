...
namespace ddp {
	...
	class double_invert_pendulum
	{
	public:
		double_invert_pendulum();
		~double_invert_pendulum();
		...
		// other methods
		void setAngle1Range(double t1, double t2, int num_ang);
		void setAngle2Range(double t1, double t2, int num_ang);
